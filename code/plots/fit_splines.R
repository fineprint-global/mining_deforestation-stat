...
# Script fits cubic splines to raw (and matched) data, approximating
# the unconditional forest loss ~ mine distance.
...
if(!exists("out_cem")) {stop("Please prepare matches in `out_cem`.")}
